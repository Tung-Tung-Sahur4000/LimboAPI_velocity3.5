...
> **Velocity-CTD fork.** This build of LimboAPI targets [Velocity-CTD](https://github.com/GemstoneGG/Velocity-CTD)
> instead of upstream Velocity. It is compiled against the `com.velocityctd` artifacts from
> `https://repo.velocityctd.com/snapshots/` and adapts the internal hooks (login injection,
> tab list, connection registration and client brand) to the CTD API. Use the upstream
> [Elytrium/LimboAPI](https://github.com/Elytrium/LimboAPI) if you run vanilla Velocity.
